...
* Use *the more idiomatic context manager pattern* below, instead of *the explicit object approach* for CodeCarbon:
...
* Use `CODEFORMAT.md` for Python code formatting guidance.